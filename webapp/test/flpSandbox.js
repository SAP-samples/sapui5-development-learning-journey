		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptrainingexc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingexc-display": {
								"semanticObject": "saptrainingexc",
								"action": "display",
								"description": "A simple app that demonstrates important concepts of SAPUI5",
								"title": "Exercise Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.exc",
									"url": sap.ui.require.toUrl("sap/training/exc")
								}
							}
						}
					}
